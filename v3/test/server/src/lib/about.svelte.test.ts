...
describe('About Component', () => {
	...
	describe('Content Rendering', () => {
		test('renders version safely', async () => {
			...
			const component = page.getByTestId('about-component');
			const versionText = component.getByText(/Router Version:/);
			await expect.element(versionText).toHaveTextContent('Router Version: <script>alert("xss")</script>');
		});
	...
	describe('Edge Cases', () => {
		test('handles very long version strings', async () => {
			...
			const component = page.getByTestId('about-component');
			const versionText = component.getByText(/Router Version:/);
			await expect.element(versionText).toHaveTextContent(`Router Version: ${longVersion}`);
		});
	...
	describe('Component Structure', () => {
		test('has correct test id', async () => {
			...
			const component = page.getByTestId('about-component');
			await expect.element(component).toHaveAttribute('data-testid', 'about-component');
		});
