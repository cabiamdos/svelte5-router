...
<div data-testid="simple-api-test">
  ...
  <nav data-testid="navigation">
    ...
    <button data-testid="nav-user-123" onclick={() => goto('/users/123')}>User 123</button>
    <button data-testid="nav-post" onclick={() => goto('/users/42/posts/99')}>Post 99</button>
    <button data-testid="nav-files" onclick={() => goto('/files/docs/test.pdf')}>Files</button>
  </nav>
